...
I'm a new-grad software engineer (BS CS, University of Florida) with an SDE
internship behind me and full-stack LLM app experience. I'm most comfortable
in Python backends and TypeScript/React frontends, and I'd like to get better
at RAG and agent code. I have limited time, so I prefer issues I can finish
in a few evenings, and I'd rather avoid heavy infra or deployment work.
